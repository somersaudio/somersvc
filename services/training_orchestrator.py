    ...
    def run(self, job_id: str, speaker_name: str, f0_method: str = "dio") -> dict:
        ...
        try:
            ...
            ssh.exec_command(
                ...
                "    # Save checkpoints more often so the auto-stop parser sees\n"
                "    # epoch numbers in time. Default is 200, which lets a low\n"
                "    # target like 25 overshoot to ~199 before the parser hears\n"
                "    # anything.\n"
                "    cfg['train']['eval_interval'] = 25\n"
