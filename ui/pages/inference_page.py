...
class InferencePage(QWidget):
    ...
    def _init_ui(self):
        ...
        self.spn_chunk.setRange(0.1, 5.0)
        self.spn_chunk.setSingleStep(0.1)
        self.spn_chunk.setValue(0.5)
        self.spn_chunk.setToolTip("Chunk size for processing")
